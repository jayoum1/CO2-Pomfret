  ...
  return (
    <div className="space-y-8">
      <div className="text-center space-y-2 pb-6 border-b border-[#1e293b]/50 animate-fade-in">
        <h1 className="text-5xl font-black gradient-text neon-glow tracking-tight animate-fade-in stagger-1">Planting Scenarios</h1>
        <p className="text-lg text-[#4ade80]/70 mt-1 animate-fade-in stagger-2">Simulate the impact of planting new trees on forest carbon sequestration</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Scenario Builder */}
        <div className="glass dark-card p-6 rounded-xl space-y-4 animate-fade-in stagger-3">
          <h2 className="text-xl font-semibold gradient-text-subtle">Scenario Builder</h2>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 glass border border-[#334155]/50 rounded-lg text-[#4ade80] placeholder:text-[#4ade80]/30 focus:ring-2 focus:ring-[#4ade80]/50 focus:border-[#4ade80]/50 transition-all"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 glass border border-[#334155]/50 rounded-lg text-[#4ade80] placeholder:text-[#4ade80]/30 focus:ring-2 focus:ring-[#4ade80]/50 focus:border-[#4ade80]/50 transition-all"
            >
              <option value="Upper" className="bg-[#0f172a]">Upper</option>
              <option value="Middle" className="bg-[#0f172a]">Middle</option>
              <option value="Lower" className="bg-[#0f172a]">Lower</option>
            </select>
          </div>
              ...
              {speciesMix.map((item, index) => (
                <div key={index} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 glass border border-[#334155]/50 rounded-lg text-sm text-[#4ade80] placeholder:text-[#4ade80]/30 focus:ring-2 focus:ring-[#4ade80]/50 focus:border-[#4ade80]/50 transition-all"
                  />
                  <input
                    type="number"
                    min="0"
                    ...
                    className="w-20 px-3 py-2 glass border border-[#334155]/50 rounded-lg text-sm text-[#4ade80] placeholder:text-[#4ade80]/30 focus:ring-2 focus:ring-[#4ade80]/50 focus:border-[#4ade80]/50 transition-all"
                  />
                  <button
          ...
          <button
            ...
            className="w-full bg-[#4ade80] text-[#0f172a] py-2 px-4 rounded-xl hover:bg-[#4ade80]/90 disabled:bg-[#334155] disabled:text-[#4ade80]/30 disabled:cursor-not-allowed transition-all font-medium shadow-[0_0_15px_rgba(74,222,128,0.3)] hover:shadow-[0_0_20px_rgba(74,222,128,0.5)] hover:scale-[1.02] active:scale-[0.98]"
          >
        ...
        {/* Results */}
        <div className="glass dark-card p-6 rounded-xl min-h-[500px] animate-fade-in stagger-3">
          <h2 className="text-xl font-semibold gradient-text-subtle mb-4">Results</h2>
          
          {scenarioResult ? (
            <div className="w-full">
              <div className="inline-flex h-10 items-center justify-center rounded-lg glass p-1 mb-4 w-full border border-[#334155]/50">
                <button
              ...
              <div className="space-y-4 mt-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="glass p-3 rounded-lg border border-[#334155]/30">
      ...
      {savedScenarios.length > 0 && (
        <div className="glass dark-card p-6 rounded-lg animate-fade-in stagger-4">
          <h2 className="text-xl font-semibold gradient-text-subtle mb-4">Saved Scenarios</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {savedScenarios.map((scenario, index) => (
              <div
                key={index}
                className="glass border border-[#334155]/30 rounded-lg p-4 hover:border-[#4ade80]/50 cursor-pointer transition-all hover:scale-[1.02] hover:shadow-[0_0_15px_rgba(74,222,128,0.2)]"
